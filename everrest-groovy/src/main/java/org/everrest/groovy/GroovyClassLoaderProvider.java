...
/**
 * Factory of Groovy class loader. It can provide preset GroovyClassLoader instance or customized
 * instance of GroovyClassLoader able resolve additional Groovy source files.
 *
 * @author andrew00x
 */
public class GroovyClassLoaderProvider {
  ...
  /**
   * Get customized instance of GroovyClassLoader that able to resolve additional Groovy source
   * files.
   *
   * @param sources additional Groovy sources
   * @return GroovyClassLoader
   * @throws MalformedURLException if any of entries in <code>sources</code> has invalid URL.
   */
