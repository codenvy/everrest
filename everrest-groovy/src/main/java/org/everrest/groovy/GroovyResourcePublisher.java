...
public class GroovyResourcePublisher {
  ...
  /**
   * Create GroovyJaxrsPublisher which is able publish per-request and singleton resources. Any
   * required dependencies for per-request resource injected by {@link PerRequestObjectFactory}.
   *
   * @param binder resource binder
   * @param classLoaderProvider GroovyClassLoaderProvider
   * @param dependencies dependencies resolver
   * @see DependencySupplier
   */
  protected GroovyResourcePublisher(
   ...
   * @param properties optional resource properties. This parameter may be <code>null</code>
   * @param src additional path to Groovy sources
   * @param files Groovy source files to be added in build path directly
   * @throws ResourcePublicationException see {@link ResourceBinder#addResource(Class,
   *     MultivaluedMap)}
   */
  public void publishPerRequest(
      InputStream in,
   ...
   *     MultivaluedMap)}
   */
  public final void publishPerRequest(
      String source,
      ResourceId resourceId,
      MultivaluedMap<String, String> properties,
      SourceFolder[] src,
   ...
   *
   * @param source groovy source code of RESTful service
   * @param charset source string charset. May be <code>null</code> than default charset will be in
   *     use
   * @param resourceId id to be assigned to resource
   * @param properties optional resource properties. This parameter may be <code>null</code>.
   * @param src additional path to Groovy sources
   ...
   * @param src additional path to Groovy sources
   * @param files Groovy source files to be added in build path directly
   * @throws ResourcePublicationException see {@link ResourceBinder#addResource(Object,
   *     MultivaluedMap)}
   */
  public void publishSingleton(
      InputStream in,
      ResourceId resourceId,
      MultivaluedMap<String, String> properties,
      SourceFolder[] src,
   ...
   *     MultivaluedMap)}
   */
  public final void publishSingleton(
      String source,
      ResourceId resourceId,
      MultivaluedMap<String, String> properties,
      SourceFolder[] src,
   ...
   * @return <code>true</code> if resource was published and <code>false</code> otherwise, e.g.
   *     because there is not resource corresponded to supplied <code>resourceId</code>
   */
  ...
  private void publishPerRequest(
      String source,
      Charset charset,
      ResourceId resourceId,
      MultivaluedMap<String, String> properties,
  ...
  protected Object createInstance(Class<?> clazz)
    ...
    throw new ResourcePublicationException(
        String.format(
            "Unable create instance of class %s. Required constructor's dependencies can't be resolved. ",
            clazz.getName()));
  }
  ...
  protected GroovyCodeSource createCodeSource(InputStream in, String name) {
    GroovyCodeSource gcs =
        new GroovyCodeSource(
            new BufferedReader(new InputStreamReader(in)), name, "/groovy/script/jaxrs");
