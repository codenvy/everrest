 ...
 * @author andrew00x
 */
public class WebAppInjectTest extends WebAppBaseTest {
    ...
    @Path("WebAppInjectTest.Resource1")
    ...
    @Path("WebAppInjectTest.Resource2")
   ...
   /* ------------------------------------------------------------- */
    ...
    @Path("WebAppInjectTest.Resource3")
    ...
    @Path("WebAppInjectTest.Resource4")
   ...
   /* ================================================================ */
    ...
    private final String injectableProviderKey = "WebAppInjectTest.Provider.Injectable";
    ...
    public void testInjectInstance() throws Exception {
        ...
        Assert.assertEquals(204, launcher.service("GET", "/WebAppInjectTest.Resource1", "", null, null, null).getStatus());
    ...
    public void testInjectProvider() throws Exception {
        ...
        Assert.assertEquals(204, launcher.service("GET", "/WebAppInjectTest.Resource2", "", null, null, null).getStatus());
