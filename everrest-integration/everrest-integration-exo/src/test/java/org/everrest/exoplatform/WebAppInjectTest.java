...
public class WebAppInjectTest extends WebAppBaseTest {
   ...
   /* ================================================================ */
    ...
    public void testInjectInstance() throws Exception {
        ...
        assertEquals(204, launcher.service("GET", "/WebAppInjectTest.Resource1", "", null, null, null).getStatus());
    ...
    public void testInjectProvider() throws Exception {
        ...
        assertEquals(204, launcher.service("GET", "/WebAppInjectTest.Resource2", "", null, null, null).getStatus());
