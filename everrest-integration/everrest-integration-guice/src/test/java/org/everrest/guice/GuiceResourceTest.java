...
public class GuiceResourceTest extends BaseTest {
  ...
  public static class MessageProvider
    ...
    public Message readFrom(
      ...
      return new Message(
          CharStreams.toString(new InputStreamReader(entityStream, getCharsetOrUtf8(mediaType))));
    }
  ...
  public void testResource() throws Exception {
    assertEquals(
        204, launcher.service("GET", "/a", "", null, messageBody.getBytes(), null).getStatus());
  }

  @Test
  public void testRemapResource() throws Exception {
    assertEquals(
        204, launcher.service("GET", "/a/b/c", "", null, messageBody.getBytes(), null).getStatus());
  }
    ...
    Module module =
        new Module() {
          public void configure(Binder binder) {
            ...
            binder
                .bind(ServiceBindingHelper.bindingKey(Resource.class, "/a/b/c"))
                .to((Resource.class));
