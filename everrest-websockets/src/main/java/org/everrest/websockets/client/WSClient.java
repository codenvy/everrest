...
public class WSClient {
   ...
   * @throws SocketTimeoutException if timeout occurs while try to connect to server endpoint
   * @throws IllegalArgumentException if {@code timeout} zero or negative
   */
  ...
  private void checkIsConnected() {
    if (!isConnected()) {
      throw new IllegalStateException(
          "Unable send message because the WebSocket connection has been closed");
    }
  }
  ...
  public static class Builder {
    ...
    public Builder(URI serverUri) {
      ...
      final List<String> channelsFromUri =
          parseQueryString(serverUri.getRawQuery(), true).get("channel");
