...
public class MethodParametersInjectionTest extends BaseTest {
    ...
    public static Object[][] injectParametersTestData() {
        return new Object[][]{
                ...
                {new QueryParamResource(), "/b/6?x=foo&x=bar", null, null, newTreeSet(newArrayList("foo", "bar"))},
                ...
                {new MatrixParamResource(), "/c/6;x=foo;x=bar", null, null, newTreeSet(newArrayList("foo", "bar"))},
                ...
                {new CookieParamResource(), "/d/1", ImmutableMap.of("Cookie", newArrayList("x=test")),      null, "test"},
                {new CookieParamResource(), "/d/2", null,                                                   null, "default"},
                {new CookieParamResource(), "/d/3", ImmutableMap.of("Cookie", newArrayList("x=test")),      null, newArrayList("test")},
                {new CookieParamResource(), "/d/4", ImmutableMap.of("Cookie", newArrayList("x=test")),      null, newHashSet("test")},
                {new CookieParamResource(), "/d/5", ImmutableMap.of("Cookie", newArrayList("x=test")),      null, newTreeSet(newArrayList("test"))},
                {new CookieParamResource(), "/d/6", ImmutableMap.of("Cookie", newArrayList("x=123")),       null, 123},
                {new CookieParamResource(), "/d/7", ImmutableMap.of("Cookie", newArrayList("x=foo,y=bar")), null, "foobar"},
                {new CookieParamResource(), "/d/8", ImmutableMap.of("Cookie", newArrayList("x=123")),       null, 123},
                {new CookieParamResource(), "/d/9", ImmutableMap.of("Cookie", newArrayList("x=test")),      null, new Cookie("x", "test")},

                {new HeaderParamResource(), "/e/1", ImmutableMap.of("x", newArrayList("test")),                          null, "test"},
                {new HeaderParamResource(), "/e/2", null,                                                                null, "default"},
                {new HeaderParamResource(), "/e/3", ImmutableMap.of("x", newArrayList("foo", "bar")),                    null, newArrayList("foo", "bar")},
                {new HeaderParamResource(), "/e/4", ImmutableMap.of("x", newArrayList("foo", "bar")),                    null, newHashSet("foo", "bar")},
                {new HeaderParamResource(), "/e/5", ImmutableMap.of("x", newArrayList("foo", "bar")),                    null, newTreeSet(newArrayList("foo", "bar"))},
                {new HeaderParamResource(), "/e/6", ImmutableMap.of("x", newArrayList("123")),                           null, 123},
                {new HeaderParamResource(), "/e/7", ImmutableMap.of("x", newArrayList("foo"), "y", newArrayList("bar")), null, "foobar"},
                {new HeaderParamResource(), "/e/8", ImmutableMap.of("x", newArrayList("123")),                           null, 123},

                {new FormParamResource(), "/f/1", ImmutableMap.of("Content-Type", newArrayList("application/x-www-form-urlencoded")), "x=test",      "test"},
                {new FormParamResource(), "/f/2", ImmutableMap.of("Content-Type", newArrayList("application/x-www-form-urlencoded")), "x=te%20st",   "te%20st"},
                {new FormParamResource(), "/f/1", ImmutableMap.of("Content-Type", newArrayList("application/x-www-form-urlencoded")), "x=te%20st",   "te st"},
                {new FormParamResource(), "/f/3", ImmutableMap.of("Content-Type", newArrayList("application/x-www-form-urlencoded")), "",            "default"},
                {new FormParamResource(), "/f/4", ImmutableMap.of("Content-Type", newArrayList("application/x-www-form-urlencoded")), "x=foo&x=bar", newArrayList("foo", "bar")},
                {new FormParamResource(), "/f/5", ImmutableMap.of("Content-Type", newArrayList("application/x-www-form-urlencoded")), "x=foo&x=bar", newHashSet("foo", "bar")},
                {new FormParamResource(), "/f/6", ImmutableMap.of("Content-Type", newArrayList("application/x-www-form-urlencoded")), "x=foo&x=bar", newTreeSet(newArrayList("foo", "bar"))},
                {new FormParamResource(), "/f/7", ImmutableMap.of("Content-Type", newArrayList("application/x-www-form-urlencoded")), "x=123",       123},
                {new FormParamResource(), "/f/8", ImmutableMap.of("Content-Type", newArrayList("application/x-www-form-urlencoded")), "x=foo&y=bar", "foobar"},
                {new FormParamResource(), "/f/9", ImmutableMap.of("Content-Type", newArrayList("application/x-www-form-urlencoded")), "x=123",       123},
        };
    }
