...
public class JsonEntityProviderTest {
  ...
  public void readsContentOfEntityStreamAsJsonValue() throws Exception {
    String content =
        "{\"title\": \"JUnit in Action\", \"pages\": 386, \"isdn\": 93011099534534, \"price\": 19.37, \"author\": \"Vincent Massol\"}";
    JsonValue result =
        (JsonValue)
            jsonEntityProvider.readFrom(
                JsonValue.class,
                null,
                null,
  ...
  public void readsContentOfEntityStreamAsMapStringToObject() throws Exception {
    String content =
        "{\"book\": {\"title\": \"JUnit in Action\", \"pages\": 386, \"isdn\": 93011099534534, \"price\": 19.37, \"author\": \"Vincent Massol\"}}";
  ...
  public void writesJsonValueToOutputStream() throws Exception {
    ...
    jsonEntityProvider.writeTo(
        jsonBook, Book.class, null, null, APPLICATION_JSON_TYPE, new MultivaluedHashMap<>(), out);

    assertEquals(
        "{\"author\":\"Vincent Massol\",\"title\":\"JUnit in Action\",\"pages\":386,\"price\":19.37,\"isdn\":93011099534534}",
        out.toString());
  }
  ...
  public void writesObjectToOutputStream() throws Exception {
    ...
    jsonEntityProvider.writeTo(
        book, Book.class, null, null, APPLICATION_JSON_TYPE, new MultivaluedHashMap<>(), out);
  ...
  public void writesArrayOfObjectsToOutputStream() throws Exception {
    ...
    jsonEntityProvider.writeTo(
        books, Book[].class, null, null, APPLICATION_JSON_TYPE, new MultivaluedHashMap<>(), out);
  ...
  public void writesCollectionOfObjectsToOutputStream() throws Exception {
    ...
    jsonEntityProvider.writeTo(
        books,
        List.class,
        newParameterizedType(List.class, Book.class),
        null,
        APPLICATION_JSON_TYPE,
  ...
  public void writesMapStringToObjectToOutputStream() throws Exception {
    ...
    jsonEntityProvider.writeTo(
        books,
        Map.class,
        newParameterizedType(Map.class, String.class, Book.class),
        null,
        APPLICATION_JSON_TYPE,
        new MultivaluedHashMap<>(),
        out);
