...
public class ObjectBuilderTest {
  ...
  @Test
  public void throwsJsonExceptionWhenConstructorThrowsExceptionWhileInstanceOfClassCreated()
      throws Exception {
    thrown.expect(JsonException.class);
    ObjectValue jsonBook = createJsonBook(createJunitBook());
  ...
  public static class ThrowsExceptionInConstructorBook extends Book {
    public ThrowsExceptionInConstructorBook() {
  ...
  public void createsMultiDimensionArrayOfObjects() throws Exception {
    ...
    Object array = ObjectBuilder.createArray(Book[][].class, jsonArray);
    assertArrayEquals(
        new Book[][] {{createJunitBook(), createCSharpBook()}, {createJavaScriptBook()}},
        (Object[][]) array);
  }
  ...
  public void returnsNullWhenCreateCollectionFromNull() throws Exception {
    Object array =
        ObjectBuilder.createCollection(
            List.class, newParameterizedType(List.class, String.class), null);
    assertNull(array);
  }
  ...
  public void returnsNullWhenCreateCollectionFromNullValue() throws Exception {
    Object array =
        ObjectBuilder.createCollection(
            List.class, newParameterizedType(List.class, String.class), new NullValue());
    assertNull(array);
  }
  ...
  public void createsListOfStrings() throws Exception {
    ...
    List list =
        ObjectBuilder.createCollection(
            List.class, newParameterizedType(List.class, String.class), jsonArray);
  ...
  public void createsListOfObjects() throws Exception {
    ...
    List list =
        ObjectBuilder.createCollection(
            List.class, newParameterizedType(List.class, Book.class), jsonArray);
  ...
  public void createsSetOfStrings() throws Exception {
    ...
    Set set =
        ObjectBuilder.createCollection(
            Set.class, newParameterizedType(Set.class, String.class), jsonArray);
  ...
  public void createsSetOfObjects() throws Exception {
    ...
    Set set =
        ObjectBuilder.createCollection(
            Set.class, newParameterizedType(Set.class, Book.class), jsonArray);
  ...
  public void createsArrayListOfStrings() throws Exception {
    ...
    ArrayList arrayList =
        ObjectBuilder.createCollection(
            ArrayList.class, newParameterizedType(ArrayList.class, String.class), jsonArray);
  ...
  public void createsListOfListOfStrings() throws Exception {
    ...
    List listOfList =
        ObjectBuilder.createCollection(
            ...
            jsonArray);
    assertEquals(
        newArrayList(newArrayList("to", "be", "or"), newArrayList("not", "to", "be")), listOfList);
  }
  ...
  public void createsSetOfEnums() throws Exception {
    ...
    Set set =
        ObjectBuilder.createCollection(
            Set.class, newParameterizedType(Set.class, BookEnum.class), jsonArray);
  ...
  public void createsListOfMaps() throws Exception {
    ...
    ObjectValue jsonObject2 =
        createJsonObject(
            "1", createJsonBook(createJunitBook()),
    ...
    List list =
        ObjectBuilder.createCollection(
            ...
            newParameterizedType(
                List.class, newParameterizedType(Map.class, String.class, Book.class)),
            jsonArray);

    assertEquals(
        newArrayList(
            ImmutableMap.of("1", createJavaScriptBook()),
  ...
  public void createsMapOfStringToString() throws Exception {
    ...
    Map map =
        ObjectBuilder.createObject(
            Map.class, newParameterizedType(Map.class, String.class, String.class), jsonObject);
  ...
  private ObjectValue givenJsonObjectThatContainsCollections() {
    ...
    ArrayValue list =
        createJsonArray(
            ...
            createJsonBook(createJavaScriptBook()));
    jsonObject.addElement("list", list);

    ArrayValue listList =
        createJsonArray(
            createJsonArray(
                createJsonBook(createJunitBook()), createJsonBook(createJavaScriptBook())),
            createJsonArray(
                createJsonBook(createCSharpBook()), createJsonBook(createJavaScriptBook())),
            createJsonArray(createJsonBook(createJunitBook()), createJsonBook(createCSharpBook())));
    ...
    ArrayValue listMap =
        createJsonArray(
            ...
            createJsonObject(
                ...
                createJsonBook(createJavaScriptBook())),
            createJsonObject(
                "1", createJsonBook(createJunitBook()), "2", createJsonBook(createCSharpBook())));
    jsonObject.addElement("listMap", listMap);

    ArrayValue listArray =
        createJsonArray(
            createJsonArray(
                createJsonBook(createJunitBook()), createJsonBook(createJavaScriptBook())),
            createJsonArray(createJsonBook(createJunitBook()), createJsonBook(createCSharpBook())),
    ...
    ObjectValue mapList =
        createJsonObject(
            ...
            "2",
                createJsonArray(
                    createJsonBook(createJunitBook()), createJsonBook(createCSharpBook())),
            "3",
                createJsonArray(
                    createJsonBook(createCSharpBook()), createJsonBook(createJavaScriptBook())));
    jsonObject.addElement("mapList", mapList);

    ObjectValue mapArray =
        createJsonObject(
            "1",
                createJsonArray(
                    createJsonBook(createJunitBook()), createJsonBook(createJavaScriptBook())),
    ...
    jsonObject.addElement(
        "listEnum",
        createJsonArray(JUNIT_IN_ACTION.name(), BEGINNING_C.name(), ADVANCED_JAVA_SCRIPT.name()));
    return jsonObject;
  }
  ...
  public void createsComplexGroovyBean() throws Exception {
    ...
    GroovyObject junitBook =
        (GroovyObject) aBookClass.getDeclaredMethod("createJunitBook").invoke(null);
    GroovyObject cSharpBook =
        (GroovyObject) aBookClass.getDeclaredMethod("createCSharpBook").invoke(null);
    GroovyObject javaScriptBook =
        (GroovyObject) aBookClass.getDeclaredMethod("createJavaScriptBook").invoke(null);
    JsonValue jsonObject =
        createJsonObject(
            "books",
            createJsonArray(
                createJsonBook(junitBook),
                createJsonBook(cSharpBook),
                createJsonBook(javaScriptBook)));

    GroovyObject groovyObject =
        (GroovyObject) ObjectBuilder.createObject(aStorageClass, jsonObject);
  ...
  private ObjectValue createJsonObject(
      String name1, JsonValue value1, String name2, JsonValue value2) {
    ObjectValue jsonObject = new ObjectValue();
  ...
  private ObjectValue createJsonBook(GroovyObject book) {
    ...
    objectValue.addElement(
        "availability", new BooleanValue((Boolean) book.getProperty("availability")));
