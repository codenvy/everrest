...
public class LinkBuilderImplTest {
  ...
  public void buildsLinkWithLinkParams() {
    Link link =
        linkBuilder.uri("http://localhost:8080/x/y/z").param("a", "b").param("c", "d").build();
  ...
  public void buildsLinkWithRelativizedUri() {
    Link link =
        linkBuilder
            .uri("http://localhost:8080/x/y/z")
            .buildRelativized(URI.create("http://localhost:8080/x"));
  ...
  public void buildsLinkWhenSpecifiedUriDoesNotShareSamePrefixWithLinkUri() {
    Link link =
        linkBuilder
            .uri("http://localhost:8080/x/y/z")
            .buildRelativized(URI.create("http://localhost2:8080/x"));
    assertEquals(URI.create("http://localhost:8080/x/y/z"), link.getUri());
  }
  ...
  public void throwsExceptionWhenValuesForBuildRelativizedLinkIsNull() {
    linkBuilder
        .uri("http://localhost:8080/x/y/z")
        .buildRelativized(URI.create("http://localhost:8080/x"), null);
  }
}
