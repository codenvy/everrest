...
public class ResponseBuilderImplTest {
  ...
  public void setsNamedHeaders() throws Exception {
    ...
    NewCookie[] cookies =
        new NewCookie[] {new NewCookie("bar", "foo"), new NewCookie("foo", "bar")};
  ...
  public void setsVariant() {
    ...
    Response response =
        new ResponseBuilderImpl()
            .status(200)
            .variant(new Variant(mediaType, language, encoding))
            .build();
  ...
  public void setsLanguageAsString() {
    Response response = new ResponseBuilderImpl().language("en-gb").build();
    assertEquals(newArrayList("en-gb"), response.getHeaders().get("Content-Language"));
  }

  @Test
  public void setsContentTypeAsString() {
    Response response = new ResponseBuilderImpl().type("text/plain").build();
  ...
  public void setsETagHeaderAsString() {
    String tag = "\"foo\"";
    Response response = new ResponseBuilderImpl().tag(tag).build();
    assertEquals(newArrayList(tag), response.getHeaders().get("ETag"));
  }
  ...
  public void setsLinkHeaderByUriAndRelation() {
    Response response =
        new ResponseBuilderImpl().link(URI.create("http://localhost:8080/bar"), "foo").build();
  ...
  public void setsLinkHeaderByUriStringAndRelation() {
    Response response = new ResponseBuilderImpl().link("http://localhost:8080/bar", "foo").build();
  ...
  public void replacesAllHeaders() {
    ...
    Response response =
        new ResponseBuilderImpl().status(200).header("foo", "bar").replaceAll(replacement).build();
  ...
  public void clonesResponseBuilder() throws Exception {
    ...
    ResponseBuilder responseBuilder =
        new ResponseBuilderImpl().status(200).entity("foo", entityAnnotations).header("a", "b");
    ...
    assertArrayEquals(
        ((ResponseImpl) response).getEntityAnnotations(),
        ((ResponseImpl) responseClone).getEntityAnnotations());
  ...
  public void removesEncodingHeaderWithNullValue() {
    String encoding = "gzip";
    Response response = new ResponseBuilderImpl().encoding(encoding).encoding(null).build();
  ...
  public void removesAllowHeaderByNullValue() {
    String[] allow = new String[] {"GET", "POST", "PUT"};
    Response response = new ResponseBuilderImpl().allow(allow).allow((String[]) null).build();
  ...
  public void setsAllowHeaderBySet() {
    ...
    Response response = new ResponseBuilderImpl().allow(allow).build();
    assertEquals(newArrayList(allow), response.getHeaders().get("Allow"));
  }
  ...
  public void removesAllowHeaderByNullSet() {
    String[] allow = new String[] {"GET", "POST", "PUT"};
    Response response = new ResponseBuilderImpl().allow(allow).allow((Set<String>) null).build();
    assertNull(response.getHeaders().get("Allow"));
  }
  ...
  public void removesExpiresByNullValue() throws Exception {
    Date expires = new SimpleDateFormat("yyyy/MM/dd").parse("2010/01/08");
    Response response = new ResponseBuilderImpl().expires(expires).expires(null).build();
    assertNull(response.getHeaders().get("Expires"));
  }

  @Test
  public void removesHeaderByNullValue() {
    Response response = new ResponseBuilderImpl().header("foo", "bar").header("foo", null).build();
  ...
  public void removesLanguageHeaderByNullString() {
    Response response = new ResponseBuilderImpl().language("en-gb").language((String) null).build();
    assertNull(response.getHeaders().get("Content-Language"));
  }
  ...
  public void removesLastModifiedHeaderByNullValue() throws Exception {
    Date lastModified = new SimpleDateFormat("yyyy/MM/dd").parse("2006/10/28");
    Response response =
        new ResponseBuilderImpl().lastModified(lastModified).lastModified(null).build();
  ...
  public void removesLocationHeaderNyNullValue() {
    URI location = URI.create("http://localhost:8080/bar");
    Response response = new ResponseBuilderImpl().location(location).location(null).build();
  ...
  public void removesETagHeaderByNullString() {
    String tag = "\"foo\"";
    Response response = new ResponseBuilderImpl().tag(tag).tag((String) null).build();
  ...
  public void removesETagHeaderByNullEntityTag() {
    EntityTag tag = new EntityTag("foo");
    Response response = new ResponseBuilderImpl().tag(tag).tag((EntityTag) null).build();
    assertNull(response.getHeaders().get("ETag"));
  }
  ...
  public void removesContentTypeByNullMediaType() {
    ...
    Response response = new ResponseBuilderImpl().type(mediaType).type((MediaType) null).build();
    assertNull(response.getHeaders().get("Content-type"));
  }

  @Test
  public void removesContentTypeByNullString() {
    Response response = new ResponseBuilderImpl().type("text/plain").type((String) null).build();
    assertNull(response.getHeaders().get("Content-type"));
  }
  ...
  public void removesLinksByNullValues() {
    Link[] links = new Link[] {Link.fromUri(URI.create("http://localhost:8080/bar")).build()};
    Response response = new ResponseBuilderImpl().links(links).links((Link[]) null).build();
