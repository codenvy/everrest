...
public class MediaTypeHeaderDelegateTest {
  ...
  public static Object[][] forTestToString() {
    return new Object[][] {
      ...
      {
        new MediaType("text", "plain", ImmutableMap.of("charset", "utf8")),
        "text/plain;charset=utf8"
      },
      {
        new MediaType("text", "plain", ImmutableMap.of("charset", "utf8", "test", "hello")),
        "text/plain;charset=utf8;test=hello"
      },
    };
  }
