...
public class RequestHandlerImplTest {
  ...
  @Test
  public void sendsResponseFromThrownWebApplicationExceptionWhenResponseHasEntity()
      throws Exception {
    WebApplicationException exception =
        new WebApplicationException(serverError().entity("Some Error").build());
    doThrow(exception).when(requestDispatcher).dispatch(request, response);
  ...
  @Test
  public void
      throwsUnhandledExceptionWithCauseOfWebApplicationExceptionWhenJspErrorPageIsAvailableForErrorStatus()
          throws Exception {
  ...
  @Test
  public void
      throwsUnhandledExceptionWithCauseOfWebApplicationExceptionWhenJspErrorPageForCauseIsAvailable()
          throws Exception {
    ErrorPages errorPages = mock(ErrorPages.class);
  ...
  @Test
  public void
      throwsUnhandledExceptionWithWebApplicationExceptionWhenJspErrorPageForWebApplicationExceptionIsAvailable()
          throws Exception {
    ErrorPages errorPages = mock(ErrorPages.class);
  ...
  @Test
  public void
      usesExceptionMapperToConvertWebApplicationExceptionToResponseWhenResponseFromWebApplicationExceptionDoesNotHaveEntity()
          throws Exception {
    WebApplicationException webApplicationException =
        new WebApplicationException(serverError().build());
    doThrow(webApplicationException).when(requestDispatcher).dispatch(request, response);
    ExceptionMapper<WebApplicationException> exceptionMapper = mock(ExceptionMapper.class);
    when(exceptionMapper.toResponse(webApplicationException))
        .thenReturn(serverError().entity("response from exception mapper").build());
  ...
  @Test
  public void
      usesMessageFromCauseOfWebApplicationExceptionForResponseEntityWhenResponseFromWebApplicationExceptionDoesNotHaveEntity()
          throws Exception {
  ...
  @Test
  public void
      usesMessageFromWebApplicationExceptionForResponseEntityWhenResponseFromWebApplicationExceptionDoesNotHaveEntity()
          throws Exception {
  ...
  @Test
  public void
      usesToStringOfCauseOfWebApplicationExceptionForResponseEntityWhenResponseFromWebApplicationExceptionDoesNotHaveEntityAndCauseDoesNotHaveMessage()
          throws Exception {
    Exception exception = new Exception();
    WebApplicationException webApplicationException = new WebApplicationException(exception);
    doThrow(webApplicationException).when(requestDispatcher).dispatch(request, response);
  ...
  @Test
  public void
      throwsUnhandledExceptionWithCauseOfInternalExceptionWhenJspErrorPageForCauseIsAvailable()
          throws Exception {
    ErrorPages errorPages = mock(ErrorPages.class);
    Exception exception = new Exception();
    when(errorPages.hasErrorPage(exception)).thenReturn(true);
  ...
  @Test
  public void
      throwsUnhandledExceptionWithInternalExceptionWhenJspErrorPageForInternalExceptionIsAvailable()
          throws Exception {
    ErrorPages errorPages = mock(ErrorPages.class);
  ...
  public void usesExceptionMapperToConvertCauseOfInternalExceptionToResponse() throws Exception {
    ...
    when(exceptionMapper.toResponse(exception))
        .thenReturn(serverError().entity("response from exception mapper").build());
  ...
  @Test
  public void
      throwsUnhandledExceptionWithCauseOfInternalExceptionWhenExceptionMapperForCauseIsNotAvailable()
          throws Exception {
    Exception exception = new Exception();
    InternalException internalException = new InternalException(exception);
    doThrow(internalException).when(requestDispatcher).dispatch(request, response);
    ...
    return new BaseMatcher<Throwable>() {
      ...
      public void describeTo(Description description) {
        description.appendText(
            String.format("Expected UnhandledException with status: %s", status));
      }
    };
  }
}
