...
public class PathSegmentImplTest {
  ...
  @Parameter(0)
  public String pathSegmentString;
  ...
  @Parameter(3)
  public List<String> expectedMatrixParameters;
  ...
  public void parsesPathSegmentsFromString() {
    ...
    for (int i = 0; i < expectedMatrixParameters.size(); i += 2) {
      ...
      assertEquals(
          expectedMatrixParameterValue, matrixParameters.getFirst(expectedMatrixParameterName));
    }
  }
}
