...
public class MultivaluedMapEntityProviderTest {
  private final ParameterizedType multiValuedMapGenericType =
      newParameterizedType(MultivaluedMap.class, String.class, String.class);
  ...
  public void isReadableForMultivaluedMap() throws Exception {
    assertTrue(
        multivaluedMapEntityProvider.isReadable(
            MultivaluedMap.class, multiValuedMapGenericType, null, null));
  }
  ...
  public void readsContentOfEntityStreamAsMultivaluedMap() throws Exception {
    MultivaluedMap<String, String> multivaluedMap =
        multivaluedMapEntityProvider.readFrom(
            (Class) MultivaluedMap.class,
            multiValuedMapGenericType,
            null,
            APPLICATION_FORM_URLENCODED_TYPE,
            new MultivaluedMapImpl(),
            new ByteArrayInputStream(testContent));
    Map<String, List<String>> decodedMap =
        ImmutableMap.of(
            "foo", newArrayList("to be or not to be"), "bar", newArrayList("hello world"));
    Map<String, List<String>> encodedMap =
        ImmutableMap.of(
            "foo",
            newArrayList("to%20be%20or%20not%20to%20be"),
            "bar",
            newArrayList("hello%20world"));
    ...
    verify(context.getAttributes())
        .put(eq("org.everrest.provider.entity.decoded.form"), argumentCaptor.capture());
    assertEquals(decodedMap, argumentCaptor.getValue());

    verify(context.getAttributes())
        .put(eq("org.everrest.provider.entity.encoded.form"), argumentCaptor.capture());
  ...
  public void getsParsedDecodedMultivaluedMapFromContextIfPresent() throws Exception {
    ...
    when(context.getAttributes().get("org.everrest.provider.entity.decoded.form"))
        .thenReturn(decodedMap);
  ...
  public void getsParametersFromServletRequestWhenEntityStreamIsEmpty() throws Exception {
    Map<String, String[]> parameterMap =
        ImmutableMap.of(
            "foo", new String[] {"to be or not to be"}, "bar", new String[] {"hello world"});
  ...
  @SuppressWarnings("unchecked")
  @Test
  public void readsContentOfEntityStreamAsMultivaluedMapWhenFormFieldMissedValue()
      throws Exception {
    ...
    MultivaluedMap<String, String> multivaluedMap =
        multivaluedMapEntityProvider.readFrom(
            ...
            new ByteArrayInputStream(testContent));
    Map<String, List<String>> decodedMap =
        ImmutableMap.of("foo", newArrayList(""), "bar", newArrayList("hello world"));
  ...
  public void writesMultivaluedMapToOutputStream() throws Exception {
    ...
    multivaluedMapEntityProvider.writeTo(
        multivaluedMap,
