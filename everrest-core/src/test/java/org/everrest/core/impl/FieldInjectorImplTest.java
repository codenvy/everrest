...
public class FieldInjectorImplTest {
  ...
  public void createsFieldInjectorForField() throws Exception {
    FieldInjectorImpl fieldInjector =
        new FieldInjectorImpl(
            Resource.class.getDeclaredField("pathParam"), parameterResolverFactory);
  ...
  public void createsFieldInjectorForEncodedField() throws Exception {
    FieldInjectorImpl fieldInjector =
        new FieldInjectorImpl(
            Resource.class.getDeclaredField("queryParam"), parameterResolverFactory);
  ...
  public void createsFieldInjectorForFieldWIthDefaultValue() throws Exception {
    FieldInjectorImpl fieldInjector =
        new FieldInjectorImpl(
            Resource.class.getDeclaredField("headerParam"), parameterResolverFactory);
  ...
  public void injectsExternalDependencyToField() throws Exception {
    ...
    when(dependencySupplier.getInstance(
            ArgumentMatchers.<Parameter>argThat(
                argument -> argument.getParameterClass() == Dependency.class)))
        .thenReturn(dependency);

    FieldInjectorImpl fieldInjector =
        new FieldInjectorImpl(
            Resource.class.getDeclaredField("dependency"), parameterResolverFactory);
    Resource instance = new Resource();
    fieldInjector.inject(instance, applicationContext);
  ...
  @Test
  public void
      throwsWebApplicationExceptionWithStatus_NOT_FOUND_WhenFieldAnnotatedWithPathParamAnnotationCanNotBeResolved()
          throws Exception {
    when(pathParameterResolver.resolve(isA(Parameter.class), eq(applicationContext)))
  ...
  @Test
  public void
      throwsWebApplicationExceptionWithStatus_NOT_FOUND_WhenFieldAnnotatedWithQueryParamAnnotationCanNotBeResolved()
          throws Exception {
  ...
  @Test
  public void
      throwsWebApplicationExceptionWithStatus_NOT_FOUND_WhenFieldAnnotatedWithMatrixParamAnnotationCanNotBeResolved()
          throws Exception {
    ...
    FieldInjectorImpl fieldInjector =
        new FieldInjectorImpl(
            Resource.class.getDeclaredField("matrixParam"), parameterResolverFactory);
    Resource instance = new Resource();
  ...
  @Test
  public void
      throwsWebApplicationExceptionWithStatus_BAD_REQUEST_WhenFieldAnnotatedWithHeaderParamAnnotationCanNotBeResolved()
          throws Exception {
    when(headerParameterResolver.resolve(isA(Parameter.class), eq(applicationContext)))
        .thenThrow(new Exception());
  ...
  @Test
  public void
      throwsWebApplicationExceptionWithStatus_BAD_REQUEST_WhenFieldAnnotatedWithCookieParamAnnotationCanNotBeResolved()
          throws Exception {
    ...
    FieldInjectorImpl fieldInjector =
        new FieldInjectorImpl(
            Resource.class.getDeclaredField("cookieParam"), parameterResolverFactory);
    Resource instance = new Resource();
  ...
  @Test
  public void
      throwsWebApplicationExceptionWithStatus_INTERNAL_SERVER_ERROR_WhenNotAnnotatedFieldCanNotBeResolved()
          throws Exception {
    when(dependencySupplier.getInstance(
            argThat(
                (ArgumentMatcher<ConstructorParameter>)
                    argument ->
                        ((FieldInjector) argument).getParameterClass() == Dependency.class)))
  ...
  public void throwsRuntimeExceptionWhenFieldHasTwoTypesOfAnnotation() throws Exception {
    ...
    new FieldInjectorImpl(
        InvalidResource.class.getDeclaredField("pathParam"), parameterResolverFactory);
  }
