...
public class StreamSourceEntityProviderTest {
  ...
  public void isReadableForStreamSource() throws Exception {
    assertTrue(
        streamSourceEntityProvider.isReadable(
            StreamSource.class, null, null, APPLICATION_XML_TYPE));
  }

  @Test
  public void isNotReadableForTypeOtherThanStreamSource() throws Exception {
    assertFalse(
        streamSourceEntityProvider.isReadable(DOMSource.class, null, null, APPLICATION_XML_TYPE));
  }

  @Test
  public void isWritableForStreamSource() throws Exception {
    assertTrue(
        streamSourceEntityProvider.isWriteable(
            StreamSource.class, null, null, APPLICATION_XML_TYPE));
  }
  ...
  public void isNotWritableForTypeOtherThanStreamSource() throws Exception {
    assertFalse(
        streamSourceEntityProvider.isWriteable(DOMSource.class, null, null, APPLICATION_XML_TYPE));
  }

  @Test
  public void readsContentOfEntityStreamAsStreamSource() throws Exception {
    StreamSource streamSource =
        streamSourceEntityProvider.readFrom(
            StreamSource.class,
            null,
            null,
    ...
    Document document =
        DocumentBuilderFactory.newInstance()
            .newDocumentBuilder()
            .parse(streamSource.getInputStream());
  ...
  public void writesStreamSourceToOutputStream() throws Exception {
    ...
    streamSourceEntityProvider.writeTo(
        new StreamSource(new ByteArrayInputStream(TEST_XML_CONTENT_BYTES)),
        StreamSource.class,
        null,
        null,
        APPLICATION_XML_TYPE,
