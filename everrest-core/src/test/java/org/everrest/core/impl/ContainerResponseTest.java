...
public class ContainerResponseTest {
    ...
    public void writesResponseWhenResponseEntityIsNotNullRequestMethodIsHEADAndContentTypeIsSetExplicitly() throws Exception {
        ...
        inOrder.verify(containerResponseWriter, never()).writeBody(same(containerResponse), any(MessageBodyWriter.class));
    }

    @Test
    public void writesResponseWhenResponseEntityIsNotNullRequestMethodIsGETAndContentTypeIsSetExplicitly() throws Exception {
        when(providers.getMessageBodyWriter(String.class, String.class, null, TEXT_PLAIN_TYPE)).thenReturn(new StringEntityProvider());
        when(containerRequest.getMethod()).thenReturn("GET");
    ...
    @Test
    public void writesResponseWhenResponseEntityIsNotNullRequestMethodIsGETAcceptHeaderIsSetAndContentTypeIsNotSet() throws Exception {
        when(providers.getMessageBodyWriter(String.class, String.class, null, TEXT_PLAIN_TYPE)).thenReturn(new StringEntityProvider());
        when(containerRequest.getMethod()).thenReturn("GET");
