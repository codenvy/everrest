...
public class ResponseImplTest {
  ...
  public void parsesContentTypeHeader() throws Exception {
    ...
    assertEquals(
        new MediaType("text", "plain", ImmutableMap.of("charset", "utf-8")),
  ...
  public void getsSetCookieHeader() throws Exception {
    ...
    List<Object> cookiesList =
        newArrayList(
            new NewCookie("name", "andrew"),
            new NewCookie(
                "company", "codenvy", "/path", "codenvy.com", 1, "comment", 300, null, true, true));
    headers.put(SET_COOKIE, cookiesList);

    ResponseImpl response = new ResponseImpl(200, "foo", null, headers);
    Map<String, NewCookie> expectedCookies =
        ImmutableMap.of(
            "name", new NewCookie("name", "andrew"),
            "company",
                new NewCookie(
                    "company",
                    "codenvy",
  ...
  public void parsesLinkHeader() throws Exception {
    ...
    assertEquals(
        newHashSet(new LinkBuilderImpl().uri("http://localhost:8080/x/y/z").rel("xxx").build()),
        response.getLinks());
  }
  ...
  public void getsLinkByRelation() throws Exception {
    ...
    assertEquals(
        new LinkBuilderImpl().uri("http://localhost:8080/x/y/z").rel("xxx").build(),
        response.getLink("xxx"));
  ...
  public void getsLinkBuilderByRelation() throws Exception {
    ...
    assertEquals(
        new LinkBuilderImpl().uri("http://localhost:8080/x/y/z").rel("xxx").build(),
        response.getLinkBuilder("xxx").build());
    assertNull(response.getLinkBuilder("yyy"));
  }

  @Test
  public void getsHeadersAsStringToStringMapAndUsesRuntimeDelegateForConvertValuesToString()
      throws Exception {
  ...
  @Test
  public void getsHeadersAsStringToStringMapAndUsesToStringMethodOfValueToConvertIt()
      throws Exception {
    RuntimeDelegate runtimeDelegate = mock(RuntimeDelegate.class);
    RuntimeDelegate.setInstance(runtimeDelegate);
  ...
  @Test
  public void getSingleHeaderAsStringAndUsesRuntimeDelegateForConvertValueToString()
      throws Exception {
    HeaderDelegate<HeaderValue> headerDelegate = mock(HeaderDelegate.class);
    when(headerDelegate.toString(isA(HeaderValue.class))).thenReturn("bar");
    RuntimeDelegate runtimeDelegate = mock(RuntimeDelegate.class);
  ...
  @Test
  public void getMultipleHeaderAsStringAndUsesRuntimeDelegateForConvertValuesToString()
      throws Exception {
    HeaderDelegate<HeaderValue> headerDelegate = mock(HeaderDelegate.class);
