...
public class EverrestConfigurationTest {
  ...
  public void copiesAllPropertiesFromOtherEverrestConfiguration() {
    ...
    EverrestConfiguration newEverrestConfiguration =
        new EverrestConfiguration(everrestConfiguration);

    assertEquals(
        everrestConfiguration.getAllProperties(), newEverrestConfiguration.getAllProperties());
  }
  ...
  public void testBooleanProperty(
      String booleanPropertyAsString, boolean expectedBooleanRepresentation) {
    everrestConfiguration.setProperty("foo", booleanPropertyAsString);
    assertEquals(
        expectedBooleanRepresentation, everrestConfiguration.getBooleanProperty("foo", false));
  }
