...
public class AsynchronousJobPoolTest {
  ...
  public void setUp() throws Exception {
    ...
    final AsynchronousFutureFactory asynchronousFutureFactory =
        mock(AsynchronousFutureFactory.class);
    when(asynchronousFutureFactory.createAsynchronousFuture(
            isA(Callable.class),
            anyLong(),
  ...
  public void addsJobInPool() throws Exception {
    ...
    assertSame(
        applicationContext.getProviders(), job.getContext().get("org.everrest.async.providers"));

    GenericContainerRequest originRequest = applicationContext.getContainerRequest();
    GenericContainerRequest copiedRequest =
