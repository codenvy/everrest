...
public class DOMSourceEntityProviderTest {
  ...
  public void isReadableForDOMSource() throws Exception {
    assertTrue(
        domSourceEntityProvider.isReadable(DOMSource.class, null, null, APPLICATION_XML_TYPE));
  }

  @Test
  public void isNotReadableForTypeOtherThanDOMSource() throws Exception {
    assertFalse(
        domSourceEntityProvider.isReadable(SAXSource.class, null, null, APPLICATION_XML_TYPE));
  }

  @Test
  public void isWritableForDOMSource() throws Exception {
    assertTrue(
        domSourceEntityProvider.isWriteable(DOMSource.class, null, null, APPLICATION_XML_TYPE));
  }

  @Test
  public void isNotWritableForTypeOtherThanDOMSource() throws Exception {
    assertFalse(
        domSourceEntityProvider.isWriteable(SAXSource.class, null, null, APPLICATION_XML_TYPE));
  }

  @Test
  public void readsContentOfEntityStreamAsDOMSource() throws Exception {
    DOMSource domSource =
        domSourceEntityProvider.readFrom(
            DOMSource.class,
            null,
            null,
  ...
  public void writesDOMSourceToOutputStream() throws Exception {
    Document document =
        DocumentBuilderFactory.newInstance()
            .newDocumentBuilder()
            .parse(new ByteArrayInputStream(TEST_XML_CONTENT_BYTES));
    ByteArrayOutputStream out = new ByteArrayOutputStream();
    domSourceEntityProvider.writeTo(
        new DOMSource(document), DOMSource.class, null, null, APPLICATION_XML_TYPE, null, out);
  ...
  private void assertThatXmlDocumentContainsAllExpectedNodes(Node document)
