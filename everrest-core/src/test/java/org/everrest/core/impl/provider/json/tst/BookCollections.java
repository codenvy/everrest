...
public class BookCollections {
  ...
  public static BookCollections createBookCollections() {
    ...
    bookCollections.setList(
        newArrayList(createJunitBook(), createCSharpBook(), createJavaScriptBook()));
    bookCollections.setListList(
        newArrayList(
            newArrayList(createJunitBook(), createJavaScriptBook()),
            newArrayList(createCSharpBook(), createJavaScriptBook()),
            newArrayList(createJunitBook(), createCSharpBook())));
    bookCollections.setListMap(
        newArrayList(
            ImmutableMap.of("1", createJunitBook(), "3", createJavaScriptBook()),
            ImmutableMap.of("2", createCSharpBook(), "3", createJavaScriptBook()),
            ImmutableMap.of("1", createJunitBook(), "2", createCSharpBook())));
    bookCollections.setListArray(
        newArrayList(
            new Book[] {createJunitBook(), createJavaScriptBook()},
            new Book[] {createJunitBook(), createCSharpBook()},
            new Book[] {createCSharpBook(), createJavaScriptBook()}));
    bookCollections.setSet(
        newHashSet(createJunitBook(), createCSharpBook(), createJavaScriptBook()));
    bookCollections.setSetSet(
        newHashSet(
            newHashSet(createJunitBook(), createJavaScriptBook()),
            newHashSet(createCSharpBook(), createJavaScriptBook()),
            newHashSet(createJunitBook(), createCSharpBook())));
    bookCollections.setSetMap(
        newHashSet(
            ImmutableMap.of("1", createJunitBook(), "3", createJavaScriptBook()),
            ImmutableMap.of("2", createCSharpBook(), "3", createJavaScriptBook()),
            ImmutableMap.of("1", createJunitBook(), "2", createCSharpBook())));
    bookCollections.setSetArray(
        newHashSet(
            new Book[] {createJunitBook(), createJavaScriptBook()},
            new Book[] {createJunitBook(), createCSharpBook()},
            new Book[] {createCSharpBook(), createJavaScriptBook()}));
    bookCollections.setMap(
        ImmutableMap.of(
            "1", createJunitBook(), "2", createCSharpBook(), "3", createJavaScriptBook()));
    bookCollections.setMapArray(
        ImmutableMap.of(
            "1", new Book[] {createJunitBook(), createJavaScriptBook()},
            "2", new Book[] {createJunitBook(), createCSharpBook()},
            "3", new Book[] {createCSharpBook(), createJavaScriptBook()}));
    bookCollections.setMapList(
        ImmutableMap.of(
            "1", newArrayList(createJunitBook(), createJavaScriptBook()),
            "2", newArrayList(createJunitBook(), createCSharpBook()),
            "3", newArrayList(createCSharpBook(), createJavaScriptBook())));
    bookCollections.setMapMap(
        ImmutableMap.of(
            "1", ImmutableMap.of("1", createJunitBook(), "2", createCSharpBook()),
            "2", ImmutableMap.of("1", createJunitBook(), "3", createJavaScriptBook()),
            "3", ImmutableMap.of("2", createCSharpBook(), "3", createJavaScriptBook())));
    bookCollections.setListEnum(
        newArrayList(
            BookEnum.JUNIT_IN_ACTION, BookEnum.BEGINNING_C, BookEnum.ADVANCED_JAVA_SCRIPT));
  ...
  public void setMapMap(Map<String, Map<String, Book>> mapMap) {
    this.mapMap = mapMap;
  }
  ...
  private boolean equals(List<Book[]> c1, List<Book[]> c2) {
    ...
    if (c1 != null && c2 != null) {
      ...
      while (iterator1.hasNext() && iterator2.hasNext()) {
        ...
        if (!Arrays.equals(o1, o2)) return false;
      }
