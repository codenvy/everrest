...
public class JsonGeneratorTest {
  ...
  public static Object[][] collectionsOfComplexObjectsForConvertToJson() {
    return new Object[][] {
      ...
      {
        newArrayList(
            createBookWrapperOne(createJunitBook()), createBookWrapperTwo(createJavaScriptBook()))
      },
      {
        newArrayList(
            createBookWrapperTwo(createJavaScriptBook()),
  ...
  @Test
  public void convertsCollectionsOfComplexObjectsToJson(Collection<Object> objects)
      throws Exception {
  ...
  public void convertsObjectWithClassFieldToJson() throws Exception {
    ...
    assertEquals(
        BeanWithClassField.class.getName(), jsonValue.getElement("klass").getStringValue());
  }
