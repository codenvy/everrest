...
public class UriTemplateParserTest {
  @Parameterized.Parameters(
      name =
          "{index} When URI template is {0} then Regex is {1}, number of literal characters is {2} and parameter names are: {3}")
  ...
  @Parameter(2)
  public int numberOfLiteralCharacters;

  @Parameter(3)
  public List<String> expectedParameterNames;
