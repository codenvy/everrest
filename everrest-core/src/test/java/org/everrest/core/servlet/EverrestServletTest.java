...
public class EverrestServletTest {
    ...
    public void setsUpEnvironmentContext() throws Exception {
        ...
        ArgumentCaptor<EnvironmentContext> envCaptor = ArgumentCaptor.forClass(EnvironmentContext.class);
        verify(everrestProcessor).process(isA(ServletContainerRequest.class), isA(ContainerResponse.class), envCaptor.capture());
