...
public class UriPattern {
  ...
  public boolean equals(Object obj) {
    return obj != null
        ...
        && getRegex().equals(((UriPattern) obj).getRegex());
  }
  ...
  /**
   * Check is URI string match to pattern. If it is then fill given list by parameter value. Before
   * coping value list is cleared. List will be 1 greater then number of keys. It can be used for
   * check is resource is matching to requested. If resource is match the last element in list must
   * be '/' or null.
   *
