...
/**
 * This class may be useful for running test and should not be used for launching services in real
 * environment, Servlet Container for example.
 *
 * @author andrew00x
 */
public class ResourceLauncher {
  ...
  public ContainerResponse service(
      String httpMethod,
      String requestURI,
      String baseURI,
    ...
    ContainerRequest request =
        new ContainerRequest(
            ...
            URI.create(baseURI),
            in,
            new InputHeadersMap(headersCopy),
            securityContext);
  ...
  public ContainerResponse service(
      ...
      throws Exception {
    return service(
        httpMethod, requestURI, baseURI, headers, data, new DummyContainerResponseWriter(), env);
  }
}
