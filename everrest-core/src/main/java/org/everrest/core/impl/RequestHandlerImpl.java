...
public class RequestHandlerImpl implements RequestHandler {
  ...
  private void handleWebApplicationException(
      WebApplicationException webApplicationException, GenericContainerResponse response) {
  ...
  @SuppressWarnings({"unchecked"})
  private void handleInternalException(
      InternalException internalException, GenericContainerResponse response) {
  ...
  @Deprecated
  private void setupInternalResponseHeaders(
      int status, MultivaluedMap<String, Object> responseHeaders) {
