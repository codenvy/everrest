...
public class DateHeaderDelegate implements RuntimeDelegate.HeaderDelegate<Date> {
  ...
  /**
   * Parses date header, header string must be in one of HTTP-date format see <a
   * href="http://www.w3.org/Protocols/rfc2616/rfc2616-sec3.html#sec3.3.1" >HTTP/1.1
   * documentation</a> otherwise IllegalArgumentException will be thrown.
   */
  @Override
