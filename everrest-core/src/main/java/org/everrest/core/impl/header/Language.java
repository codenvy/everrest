...
public class Language {
  ...
  /**
   * Gets primary-tag of language tag, e. g. if Language tag 'en-gb' then 'en' is primary-tag. See
   * <a href="http://www.w3.org/Protocols/rfc2616/rfc2616-sec14.html#sec3.10" >HTTP/1.1
   * documentation</a>.
   *
   ...
   * href="http://www.w3.org/Protocols/rfc2616/rfc2616-sec14.html#sec3.10" >HTTP/1.1
   * documentation</a>.
   *
  ...
  public boolean isCompatible(Language other) {
    ...
    return primaryTag.equals(other.primaryTag) && (subTag.isEmpty() || subTag.equals(other.subTag));
  }
