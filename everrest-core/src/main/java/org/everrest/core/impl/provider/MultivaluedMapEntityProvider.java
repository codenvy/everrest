...
public class MultivaluedMapEntityProvider
   ...
   *
   * @param pair string for processing
   * @param encodedForm {@link MultivaluedMap} to add encoded result of parsing
   * @param decodedForm {@link MultivaluedMap} to add decoded result of parsing
   * @throws UnsupportedEncodingException if supplied string can't be decoded
   */
  private void parseKeyValuePair(
      String pair,
      MultivaluedMap<String, String> encodedForm,
      MultivaluedMap<String, String> decodedForm)
