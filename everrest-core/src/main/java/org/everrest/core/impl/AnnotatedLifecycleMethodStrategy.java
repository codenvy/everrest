...
/**
 * Implementation of LifecycleComponent.LifecycleMethodStrategy that uses {@link PostConstruct} and
 * {@link PreDestroy} annotation to find "initialize" and "destroy" methods.
 */
public final class AnnotatedLifecycleMethodStrategy implements LifecycleMethodStrategy {
  ...
  private static class MethodFilter {
    ...
    /**
     * Check is method may be used as PostConstruct/PreDestroy method. There are some limitations
     * according to requirements usage of {@link PostConstruct} and {@link PreDestroy} annotation :
     *
     * <ul>
     *   <li>Method is annotated with {@link #annotation}.
     *   <li>Method must not be static.
     *   <li>Method has not have any parameters.
     *   <li>The return type of the method must be void.
     *   <li>Method must not throw checked exception.
     * </ul>
     *
  ...
  private static final MethodFilter POST_CONSTRUCT_METHOD_FILTER =
      new MethodFilter(PostConstruct.class);
