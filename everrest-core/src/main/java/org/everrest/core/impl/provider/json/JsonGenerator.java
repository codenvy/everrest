...
public class JsonGenerator {
   ...
   * @throws JsonException if collection can't be transformed in JSON representation
   */
  ...
  /**
   * Create JSON array from specified object. Parameter <code>array</code> must be array.
   *
