...
public class DataSourceEntityProvider implements EntityProvider<DataSource> {
  ...
  /**
   * Create DataSource instance dependent entity size. If entity has size less then
   * <tt>MAX_BUFFER_SIZE</tt> then {@link ByteArrayDataSource} will be created otherwise {@link
   * MimeFileDataSource} will be created.
   *
   ...
   */
  private DataSource createDataSource(InputStream entityStream, String mimeType)
      throws IOException {
