...
public class ResponseImpl extends Response {
  ...
  /** Annotations that will be passed to the {@link jakarta.ws.rs.ext.MessageBodyWriter}. */
  ...
  private Date getDateHeader(String name) {
    ...
    return HeaderHelper.parseDateHeader(
        value instanceof String ? (String) value : getHeaderAsString(value));
  }
  ...
  public Set<Link> getLinks() {
    ...
    for (Object value : links) {
      if (value instanceof Link) {
        ...
        linkSet.add(
            Link.valueOf(value instanceof String ? (String) value : getHeaderAsString(value)));
      }
    }
    return linkSet;
  }
  ...
  public String getHeaderString(String name) {
    ...
    List<String> headerStrings =
        headers.stream().map(HeaderHelper::getHeaderAsString).collect(toList());
  ...
  public static class ResponseBuilderImpl extends ResponseBuilder {
    ...
    static final Set<CaselessStringWrapper> SINGLE_VALUE_HEADERS =
        newHashSet(
            new CaselessStringWrapper(CACHE_CONTROL),
    ...
    protected ResponseBuilderImpl(ResponseBuilderImpl other) {
      ...
      if (other.entityAnnotations != null) {
        ...
        System.arraycopy(
            other.entityAnnotations, 0, this.entityAnnotations, 0, this.entityAnnotations.length);
      }
    }
