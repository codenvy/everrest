...
public class EverrestConfiguration {
  ...
  public static final String EVERREST_ASYNCHRONOUS_SERVICE_PATH =
      "org.everrest.asynchronous.service.path";
  public static final String EVERREST_ASYNCHRONOUS_POOL_SIZE =
      "org.everrest.asynchronous.pool.size";
  public static final String EVERREST_ASYNCHRONOUS_QUEUE_SIZE =
      "org.everrest.asynchronous.queue.size";
  public static final String EVERREST_ASYNCHRONOUS_CACHE_SIZE =
      "org.everrest.asynchronous.cache.size";
  public static final String EVERREST_ASYNCHRONOUS_JOB_TIMEOUT =
      "org.everrest.asynchronous.job.timeout";
  public static final String METHOD_INVOKER_DECORATOR_FACTORY =
      "org.everrest.core.impl.method.MethodInvokerDecoratorFactory";
  /**
   * Max buffer size configuration parameter. Entities that has size greater then specified will be
   * stored in temporary directory on file system during entity processing.
   */
  ...
  public int getAsynchronousPoolSize() {
    return getNumberProperty(EVERREST_ASYNCHRONOUS_POOL_SIZE, defaultAsynchronousPoolSize)
        .intValue();
  }
  ...
  public int getAsynchronousQueueSize() {
    return getNumberProperty(EVERREST_ASYNCHRONOUS_QUEUE_SIZE, defaultAsynchronousQueueSize)
        .intValue();
  }
  ...
  public int getAsynchronousCacheSize() {
    return getNumberProperty(EVERREST_ASYNCHRONOUS_CACHE_SIZE, defaultAsynchronousCacheSize)
        .intValue();
  }
  ...
  public int getAsynchronousJobTimeout() {
    return getNumberProperty(EVERREST_ASYNCHRONOUS_JOB_TIMEOUT, defaultAsynchronousJobTimeout)
        .intValue();
  }
