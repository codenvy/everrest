...
public class ServletContainerRequest extends ContainerRequest {
  ...
  private static final org.slf4j.Logger LOG =
      LoggerFactory.getLogger(ServletContainerRequest.class);
  ...
  private ServletContainerRequest(
      String method,
      URI requestUri,
      URI baseUri,
   ...
   */
  private static URL parseForwardedHostHeader(
      String forwardedHostAndPort, HttpServletRequest servletRequest) {
