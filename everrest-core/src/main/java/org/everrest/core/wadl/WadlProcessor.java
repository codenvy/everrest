...
/**
 * This class manages process of creation WADL document which describe {@link
 * org.everrest.core.resource.ResourceDescriptor}.
 *
 * @author andrew00x
 */
public class WadlProcessor {
   ...
   * representation.
   *
   * @param resourceDescriptor see {@link org.everrest.core.resource.ResourceDescriptor}
  ...
  private void processSubResourceMethods(
    ...
    for (Map.Entry<String, org.everrest.core.wadl.research.Resource> entry :
  ...
  private void processSubResourceLocators(
    ...
    for (SubResourceLocatorDescriptor srld : resourceDescriptor.getSubResourceLocators().values()) {
      ResourceDescriptor subResourceDescriptor =
          new AbstractResourceDescriptor(srld.getMethod().getReturnType()) {
            @Override
      ...
      org.everrest.core.wadl.research.Resource wadlSubResource =
   ...
   */
  private org.everrest.core.wadl.research.Method processMethod(
   ...
   */
  private org.everrest.core.wadl.research.Request processRequest(
      ResourceMethodDescriptor rmd, Map<String, Param> wadlResourceParams) {
