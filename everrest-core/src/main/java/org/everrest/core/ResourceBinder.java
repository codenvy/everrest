...
public interface ResourceBinder {
  ...
  /**
   * Get list of all registered root resources. Returned list is the copy of original list. Any
   * changes in this list do not impact to original list.
   *
  ...
  /**
   * Register supplied class as per-request root resource if it has valid JAX-RS annotations and no
  ...
  /**
   * Register supplied class as per-request root resource if it has valid JAX-RS annotations and no
   * one resource with the same <code>uriPattern</code> already registered. Resource class doesn't
   * need to be annotated with &#064Path annotation (but may be). Anyway <code>uriPattern</code>
   * parameter overwrites value of &#064Path annotation.
   *
   * @param uriPattern class of candidate to be root resource
   * @param resourceClass class of candidate to be root resource
   * @param properties optional resource properties. It may contains additional info about resource,
   *     e.g. description of resource, its responsibility, etc. This info can be retrieved {@link
   *     ObjectModel#getProperties()}. This parameter may be <code>null</code>
   * @throws ResourcePublicationException if resource can't be published because to:
   *     <ul>
   *       <li><code>uriPattern</code> is <code>null</code> or empty
   *       <li>resource has not any method with JAX-RS annotations
   *       <li>JAX-RS annotations are ambiguous or invalid
   *       <li>resource with the sane {@link UriPattern} already registered
   *     </ul>
  ...
  /**
   * Register supplied Object as singleton root resource if it has valid JAX-RS annotations and no
   * one resource with the same UriPattern already registered.
   *
   ...
   * one resource with the same <code>uriPattern</code> already registered. Resource class doesn't
   * need to be annotated with &#064Path annotation (but may be). Anyway <code>uriPattern</code>
   * parameter overwrite value of &#064Path annotation.
   *
   * @param resource candidate to be root resource
   * @param properties optional resource properties. It may contains additional info about resource,
   *     e.g. description of resource, its responsibility, etc. This info can be retrieved {@link
   ...
   * @throws ResourcePublicationException if resource can't be published because resource with the
   *     sane {@link UriPattern} already registered
   */
   ...
   */
  ObjectFactory<ResourceDescriptor> getMatchedResource(
   ...
   * @return removed resource or <code>null</code> if resource of specified class not found
   */
   ...
   * @return removed resource or <code>null</code> if resource for specified template not found
   */
