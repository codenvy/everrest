...
public interface ExtHttpHeaders extends HttpHeaders {
  ...
  /**
   * Forwarded Host header. See <a href='http://tools.ietf.org/html/rfc7239#section-5.3'>Forwarded
   * HTTP Extension sec. 5.3 Forwarded Host</a>.
   */
  public static final String FORWARDED_HOST = "X-Forwarded-Host";

  /**
   * Forwarded Protocol header. See <a href='http://tools.ietf.org/html/rfc7239#section-5.4'>
  ...
  /**
   * This header indicates that body is provided via JAXR framework. Value of header MAY contain
   * additional information about the nature of body's content, for example: 'Error-Message'.
   */
  @Deprecated public static final String JAXRS_BODY_PROVIDED = "JAXRS-Body-Provided";
}
